...
function updateStats()
{
    ...
    let hastePerc = (document.getElementByID("headenchant").value == "Libram of Rapidity" ? 1 : 0) + (document.getElementByID("legenchant").value == "Libram of Rapidity" ? 1 : 0) + (document.getElementByID("handenchant").value == "Minor Haste" ? 1 : 0);
        hastePerc += _wcb ? 15 : 0;
